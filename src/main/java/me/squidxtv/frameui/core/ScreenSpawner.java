...
/**
 * The {@code ScreenSpawner} is responsible for spawning and despawning {@link Screen} instances.
 */
public interface ScreenSpawner {
    ...
    /**
     * Updates the display of the given {@link Screen}.
     * Used for reflecting the pixel changes to the viewers by sending information with packets or similar.
     * @param screen the screen to be updated
     */
    default void update(Screen screen) {
    }
